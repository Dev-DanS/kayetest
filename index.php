                            ...
                            <form action="login_back.php" method="POST">
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right"
                                        style="font-weight:bold; color:white;">E-Mail Address</label>
                                    <div class="col-md-5">
                                ...
                                <div class="col-md-6 offset-md-3 text-center">
                                    <div style="text-align: center;">
                                        <input type="submit" value="Login" name="login"
                                            style="background-color: white; color: black;  border-radius: 20px;">
                                    </div>
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        <li class="nav-item">
                                            <a class="nav-link" href=""
                                                style="font-weight:bold; color:white;  text-align: center;">Dont have an
                                                account? SIGN UP as:</a>
                                            <a class="nav-link" href="driversignup.php"
                                                style="font-weight:bold; color:white;  text-align: center;">Driver</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="commutersignup.php"
                                                style="font-weight:bold; color:white;  text-align: center; ">Commuter</a>
                                        </li>
                                    </ul>
